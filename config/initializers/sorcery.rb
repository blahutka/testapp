...
Rails.application.config.sorcery.submodules = [:user_activation, :http_basic_auth, :remember_me,
...
Rails.application.config.sorcery.configure do |config|
  ...
  # https://graph.facebook.com/oauth/authorize?client_id=304055022939018&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Foauth%2Fcallback%3Fprovider%3Dfacebook&
  #scope=email%2Coffline_access&response_type=code
  #
  # config.github.key = ""
  ...
  config.user_config do |user|
    ...
    user.reset_password_time_between_emails = 5.minutes # hammering protection,
    # how long to wait
    # before allowing
    # another email to be
    # sent.
    ...
    user.consecutive_login_retries_amount_limit = 20 # how many failed logins allowed.

    user.login_lock_time_period = 20.minutes # how long the user should be
    ...
    user.activity_timeout = 30.minutes # how long since last activity is
    # the user defined logged out?

    # -- external --
    user.authentications_class = AuthenticationProvider # class which holds the various
